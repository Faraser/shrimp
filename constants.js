...
const M = {
  ...
  SETTINGS_NAME_MAX_LENGTH: 40,
  SETTINGS_EMAIL_MAX_LENGTH: 40,
  SETTINGS_FULLNAME_MAX_LENGTH: 40,
  SETTINGS_COUNTRY_MAX_LENGTH: 15,
  SETTINGS_CITY_MAX_LENGTH: 15,
  SETTINGS_INFO_MAX_LENGTH: 300,
};
